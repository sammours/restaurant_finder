...
/***/ "./node_modules/@ionic/core/dist/esm/es2017/build/x4ue4dpx.sc.entry.js":
/*!*****************************************************************************!*\
  !*** ./node_modules/@ionic/core/dist/esm/es2017/build/x4ue4dpx.sc.entry.js ***!
  \*****************************************************************************/
...
class ActionSheet {
    ...
    dispatchCancelHandler(ev) {
        ...
        if (Object(_chunk_265f51bc_js__WEBPACK_IMPORTED_MODULE_1__["b"])(role)) {
            const cancelButton = this.getButtons().find(b => b.role === 'cancel');
            this.callButtonHandler(cancelButton);
        }
    }
    present() {
        return Object(_chunk_265f51bc_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this, 'actionSheetEnter', iosEnterAnimation, mdEnterAnimation);
    }
    dismiss(data, role) {
        return Object(_chunk_265f51bc_js__WEBPACK_IMPORTED_MODULE_1__["d"])(this, data, role, 'actionSheetLeave', iosLeaveAnimation, mdLeaveAnimation);
    }
    onDidDismiss() {
        return Object(_chunk_265f51bc_js__WEBPACK_IMPORTED_MODULE_1__["e"])(this.el, 'ionActionSheetDidDismiss');
    }
    onWillDismiss() {
        return Object(_chunk_265f51bc_js__WEBPACK_IMPORTED_MODULE_1__["e"])(this.el, 'ionActionSheetWillDismiss');
    }
...
class ActionSheetController {
    create(opts) {
        return Object(_chunk_265f51bc_js__WEBPACK_IMPORTED_MODULE_1__["f"])(this.doc.createElement('ion-action-sheet'), opts);
    }
    dismiss(data, role, id) {
        return Object(_chunk_265f51bc_js__WEBPACK_IMPORTED_MODULE_1__["g"])(this.doc, data, role, 'ion-action-sheet', id);
    }
    async getTop() {
        return Object(_chunk_265f51bc_js__WEBPACK_IMPORTED_MODULE_1__["h"])(this.doc, 'ion-action-sheet');
    }
