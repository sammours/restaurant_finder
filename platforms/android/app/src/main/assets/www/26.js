...
/***/ "./node_modules/@ionic/core/dist/esm/es2017/build/6eqoprbr.sc.entry.js":
/*!*****************************************************************************!*\
  !*** ./node_modules/@ionic/core/dist/esm/es2017/build/6eqoprbr.sc.entry.js ***!
  \*****************************************************************************/
...
class Toast {
    ...
    async present() {
        await Object(_chunk_265f51bc_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, this.position);
        if (this.duration > 0) {
    ...
    dismiss(data, role) {
        ...
        return Object(_chunk_265f51bc_js__WEBPACK_IMPORTED_MODULE_1__["d"])(this, data, role, 'toastLeave', iosLeaveAnimation, mdLeaveAnimation, this.position);
    }
    onDidDismiss() {
        return Object(_chunk_265f51bc_js__WEBPACK_IMPORTED_MODULE_1__["e"])(this.el, 'ionToastDidDismiss');
    }
    onWillDismiss() {
        return Object(_chunk_265f51bc_js__WEBPACK_IMPORTED_MODULE_1__["e"])(this.el, 'ionToastWillDismiss');
    }
    hostData() {
        return {
            style: {
...
class ToastController {
    create(opts) {
        return Object(_chunk_265f51bc_js__WEBPACK_IMPORTED_MODULE_1__["f"])(this.doc.createElement('ion-toast'), opts);
    }
    dismiss(data, role, id) {
        return Object(_chunk_265f51bc_js__WEBPACK_IMPORTED_MODULE_1__["g"])(this.doc, data, role, 'ion-toast', id);
    }
    async getTop() {
        return Object(_chunk_265f51bc_js__WEBPACK_IMPORTED_MODULE_1__["h"])(this.doc, 'ion-toast');
    }
